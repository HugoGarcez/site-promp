  ...
  <header
    ...
    <div class="container mx-auto px-4 h-20 flex items-center justify-between">
      ...
      <NuxtLink to="/" class="flex items-center gap-2 group">
        <NuxtImg src="/images/logo-white.png" alt="Promp" class="h-8 w-auto dark:hidden" />
        <NuxtImg src="/images/logo-black.png" alt="Promp" class="h-8 w-auto hidden dark:block" />
      </NuxtLink>
