      ...
      <div class="container mx-auto px-4">
        <div class="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div class="space-y-8 animate-fade-in-up lg:col-span-5">
            <div
              class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 text-xs font-semibold uppercase tracking-wider">
              <span class="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
              Plataforma de Automação #1
            </div>

            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white leading-tight">
              Transforme seu <br>
              <span class="inline-block md:whitespace-nowrap">
                <Transition name="fade" mode="out-in">
                  <span :key="currentPlatform.name" :style="{ color: currentPlatform.textColor }" class="inline-block">
            ...
            <p class="text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-lg">
              Automatize atendimento 24/7, qualifique leads e feche mais vendas sem esforço manual. A revolução do
              atendimento para empresas que querem crescer.
            </p>
          ...
          <div class="space-y-6">
            ...
            <a href="#pricing"
              ...
              <svg xmlns="http://www.w3.org/2000/svg"
                class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                      ...
                      <div
                        ...
                        <div class="flex-1 min-w-0">
                          <p class="text-[11px] font-bold text-slate-700 dark:text-white truncate">Voz Humanizada
                            Ativada</p>
                          <div class="mt-1.5 w-full bg-slate-100 dark:bg-slate-700 h-1.5 rounded-full overflow-hidden">
                            <div class="h-full bg-secondary rounded-full animate-progress"
